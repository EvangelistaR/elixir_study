defmodule Rocketpay.Users.Create do
  ...
  def call(params) do
    ...
    # permite fazer qualquer operacao no bd com o Repo e podemos ler a operacao anterior
    # usando funcao anonima para obter o usuario criado na transacao anterior
